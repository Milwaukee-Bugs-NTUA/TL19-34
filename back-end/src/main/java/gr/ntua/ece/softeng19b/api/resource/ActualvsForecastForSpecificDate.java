 ...
 */
public class ActualvsForecastForSpecificDate extends EnergyResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        try {
            ...
            List<AVFRecordForSpecificDay> result = dataAccess.fetchActualvsForecastForSpecificDate(areaName, resolution,
                    date, userName);
            return format.generateRepresentationAVFFSD(result);
        } catch (Exception e) {
